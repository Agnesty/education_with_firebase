...
class QuizLatCtr extends GetxController {
...
// class QuizLatCtr extends GetxController {
//   final loadingStatus = LoadingStatus.loading.obs;
//   late QuizLatihanModel quizLatihanModel;
//   final allQuizLat = <Questions>[].obs;
//   Rxn<Questions> QuizLatObj = Rxn<Questions>();

//   @override
//   void onReady() {
//     final _questionsPaper = Get.arguments as QuizLatihanModel;
//     // print(_questionsPaper.id);
//     loadData(_questionsPaper);
//     super.onReady();
//   }

//   Future<void> loadData(QuizLatihanModel questionsPaper) async {
//     quizLatihanModel = questionsPaper;
//     loadingStatus.value = LoadingStatus.loading;

//     try {
//       final QuerySnapshot<Map<String, dynamic>> quizLatQuery =
//           await quizLatihanFR
//               .doc(questionsPaper.id)
//               .collection("questions")
//               .get();
//       final quizLat = quizLatQuery.docs
//           .map((quizLat) => Questions.fromSnapshot(quizLat))
//           .toList();
//       questionsPaper.questions = quizLat;

//       for (Questions _quizLat in questionsPaper.questions!) {
...
//                 .collection("answers")
//                 .get();
//         final answer = answersQuery.docs
//             .map((answer) => (Answer.fromSnapshot(answer)))
//             .toList();
//         _quizLat.answers = answer;
//         if (questionsPaper.questions != null && questionsPaper.questions!.isNotEmpty) {
//           allQuizLat.assignAll(questionsPaper.questions!);
//           QuizLatObj.value = questionsPaper.questions![0];
//           if(kDebugMode){
//             print(questionsPaper.questions![0].question);
//           }
//           loadingStatus.value = LoadingStatus.completed;
//         } else {
//           loadingStatus.value = LoadingStatus.error;

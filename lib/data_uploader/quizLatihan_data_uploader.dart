...
// class QuizLatihanDataUploader extends GetxController {
//   @override
//   void onReady() {
//     uploadData();
//     super.onReady();
...
//         .where((path) =>
//             path.startsWith('assets/DB/latihan/') && path.contains('.json'))
//         .toList();

//     List<QuizLatihanModel> quizLatihanPapers = [];
...
//       //add data to model
//       quizLatihanPapers
//           .add(QuizLatihanModel.fromJson(json.decode(stringPaperContent)));
//     }
...
//     for (var paper in quizLatihanPapers) {
//       batch.set(quizLatihanFR.doc(paper.id), {
//         "title": paper.title,
...
//         final questionPath =
//             quizLatFR(paperId: paper.id, questionId: questions.id);
